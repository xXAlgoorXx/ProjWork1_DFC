...
def main():
    ...
    for modelname in tqdm(resnetModels,position=0,desc="Models"):
        ...
        textembeddings = {"1":dictlvl1,"2":dictlvl2,"3":dictlvl3,"Use5Scentens":use5Scentens}
        saveAsJson(textembeddings,ptf.evaluationFolder /"TextEmbeddings",f"textEmbeddings_{modelname}")
